...
public class ArchiveServiceRS 
{
    ...
    {
        LOG.info("ArchiveServiceRS:starting Dicom Device");
    ...
    public void stop()
    {
        LOG.info("ArchiveServiceRS:stopping Dicom Device");
        archiveService.stop();
    }
    ...
    {
        boolean running = archiveService.isRunning();
        LOG.info("ArchiveServiceRS:stopping:is running:"+running);
        return running;
    }
    ...
    {
        LOG.info("ArchiveServiceRS:reloading");
        archiveService.reload();
    }    
}
